  ...
  if (isConnected) {
    return (
      <div className="flex flex-col items-center gap-6 py-8">
        ...
        <p className="text-sm font-medium text-success">Ledger device connected</p>
      </div>
    )
  }
    ...
    <div className="flex flex-col items-center gap-6 py-8">
      <div className="relative">
        ...
        {isConnecting && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="h-32 w-32 rounded-full border-2 border-foreground/20 animate-ping" />
          </div>
        )}
      </div>
      ...
      <div className="text-center">
        {isConnecting ? (
          ...
          <span className="text-sm text-muted-foreground">Insert your Ledger device</span>
        )}
      </div>
    </div>
  )
